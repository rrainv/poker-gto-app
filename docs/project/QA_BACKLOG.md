...
Last consolidated: September 3, 2026 (the Home Hand lifecycle, Training Memory availability, and standalone Same Spot maintenance regressions are human accepted; `LIGHT-WINS-BATCH-001` is active next).
