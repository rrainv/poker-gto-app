...
Last consolidated: August 26, 2026 (`HANDS-ON-PRODUCT-REVIEW-001` captured 59 product-owner-confirmed findings; `HANDS-ON-DEFECTS-001` owns the active bounded repair; `PERSONAL-STRATEGY-003A` is planned next; no confirmed finding is closed by documentation).
...
| ID | Status | Issue | Owner |
|---|---|---|---|
| QA-TABLE-VNEXT-001 | PARTIAL / ACCEPTED CHECKPOINT DEBT | Pure deterministic tests cover all 2–10 player templates, normalized anchors, Hero-bottom invariance, geometry families, seat prominence, layered physical table facts, projection sizing targets, RTL-stable poker geometry, and deep immutability. Human acceptance passed corrected scale and overall table coherence; revealed-opponent card inspectability remains shared card-presentation debt. | `RET-CARDS-THEMES-001` / `QA-HANDSON-021` |
...
| QA-REVIEW-NAV-001 | DEFERRED / PRODUCT DESIGN | Compare the current horizontal Action Path/timeline with a vertical chronological navigator and collapsible street groups for scanability, first-class rail controls, current-decision visibility, direct Replay seeking, compact stage, coherent live/Replay geometry, long-hand and 1080p efficiency, Deep Hand Review fit, EN/RU/HE, RTL, and keyboard access. Horizontal orientation is current implementation, not permanent acceptance. | `REPLAY-RAIL-NAV-001` / `RET-REVIEW-NAV-001` |
| QA-TABLE-VNEXT-003 | PARTIAL / ACCEPTED CHECKPOINT DEBT | Existing experience events retain stack-to-contribution lanes, contribution-to-pot/pot-to-winner paths, seat-relative deals, table-interior folds, street/actor/hand-complete consequences, direct-seek suppression, and reduced-motion safety. Human acceptance passed contribution-to-pot presentation as sufficient; elaborate choreography, fake 3D, and ambience remain deferred. | `RET-AUDIO-001` later audio acceptance |
| QA-AUDIO-MOTION-001 | PARTIAL / CONFIRMED REGRESSION DEBT | Accepted architecture checkpoint: the event/audio boundary and materially improved physical foley remain useful. HPR-2026-08 #32 confirms that poker sounds can overlap and mask one another; #47 confirms later Study/UI feedback-quality debt. Do not claim subjective perfection. | `HANDS-ON-DEFECTS-001` for overlap; `GLOBAL-PRODUCT-QUALITY-001` / `RET-AUDIO-001` for later quality |
...
|---|---|---|---|
| HPR-2026-08 #4, #21, #28, #31–33, #38–40, #43–46, #48, #52 | ACTIVE / BOUNDED | Confirmed correctness, legibility, feedback, card-removal, empty/error, transition-safety, and regression-sized geometry repairs. #28 and #46 remain split if inspection proves a redesign is required. | `HANDS-ON-DEFECTS-001` |
| HPR-2026-08 #5, #16–17 | DEFERRED / NAMED OWNER | Recurring launch/home model, onboarding separation, and useful Guest Home density. | `FIRST-USE-HOME-001` |
...
| HPR-2026-08 #19–20; #21 after bounded repair | DEFERRED / NAMED OWNER | Denser Riverline-integrated Home Game presentation, useful table/session representation, and broader lifecycle feedback. | `HOME-GAME-PRESENTATION-001` |
...
| HPR-2026-08 #29, #34; #28 and #33 after bounded repair | DEFERRED / NAMED OWNER | Vertical chronology/collapsible streets, rail controls, compact stage, and coherent live/Replay composition. | `REPLAY-RAIL-NAV-001` |
...
| HPR-2026-08 #46 after bounded repair | DEFERRED / NAMED OWNER | Stable Training result composition and useful rail allocation beyond regression repair. | `TRAINING-COMPOSITION-001` |
| HPR-2026-08 #49–51, #54 | PLANNED NEXT | Game setup/Approach first value, broad sparse/high-information coverage before boundary refinement, and Teach Riverline Next/Matrix Edit consolidation. | `PERSONAL-STRATEGY-003A` |
...
| QA-HANDSON-014 | PARTIAL / ACCEPTED FOUNDATION WITH CONFIRMED DEBT | Training's redesigned main decision/context hierarchy remains useful. HPR-2026-08 #43–46 confirms broken-looking pre-session regions, severe Progress wrapping, unsafe active-session transition, and major answer-state recomposition. Bounded defects are active; broader distribution must preserve the central decision while using rails only where useful. | `HANDS-ON-DEFECTS-001`; `TRAINING-COMPOSITION-001`; `RET-COMPOSITION-002` |
...
| QA-HANDSON-021 | PARTIAL / HUMAN DEBT CONFIRMED | Known-card rendering preserves rank+suit identity and hidden-card privacy, but human Table acceptance found that legitimately revealed opponent cards—especially at the top seat—can be substantially obscured or crowded by the seat panel, action treatment, or cradle geometry. Future work must make full identity comfortably inspectable across applicable table/review consumers while preserving HU through full-ring geometry and Dealer separation. | `RET-CARDS-THEMES-001` shared card-presentation pass |
...
| QA-MATRIX-001 | PARTIAL / CONFIRMED DEBT | Matrix retains dominant-action tint, full-mix band, and hover/focus cues. HPR-2026-08 confirms distant selected-hand detail, unclear comparison, inconsistent card removal, raw labels, and a missing local/persistent legend; final live acceptance remains pending. | `HANDS-ON-DEFECTS-001`; `ANALYZE-RANGE-UX-001` |
