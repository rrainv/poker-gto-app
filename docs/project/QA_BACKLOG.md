...
Last consolidated: September 1, 2026 (`ANALYZE-SCENARIO-READINESS-001` and `CARD-CLEAR-SEMANTICS-001` are human accepted; `HOME-HAND-LIFECYCLE-001` is active next, followed by `SAME-SPOT-COHERENCE-001`).
...
| QA-AUDIT-SAME-SPOT-COHERENCE-001 | OPEN / PLANNED NEXT | Same Spot may break session mode, mode label, or headline-stat coherence. | `SAME-SPOT-COHERENCE-001`, immediately after `HOME-HAND-LIFECYCLE-001` |
...
| QA-AUDIT-HOME-COMPLETED-HAND-001 | OPEN / ACTIVE NEXT | Home may present a completed Hand as live/continuable. | `HOME-HAND-LIFECYCLE-001` |
