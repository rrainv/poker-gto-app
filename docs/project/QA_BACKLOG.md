...
Last consolidated: August 31, 2026 (`STRATEGY-TRUST-001` is accepted; `DECISION-CONTEXT-SINGLE-AUTHORITY-001` now leads the remaining foundation debt, and blind findings stay with their named owners).
