...
Last consolidated: August 27, 2026 (`HANDS-ON-DEFECTS-001` is a completed/accepted bounded repair checkpoint with explicit structural and newly discovered debt; `CORE-FLOW-CORRECTNESS-001` is active next before `REPLAY-RAIL-NAV-001`; no broad HPR or composition closure is implied).
...
| ID | Status | Issue | Owner |
|---|---|---|---|
| QA-TABLE-VNEXT-001 | PARTIAL / ACCEPTED FOUNDATION WITH STRUCTURAL DEBT | Pure deterministic tests cover all 2–10 player templates, normalized anchors, Hero-bottom invariance, geometry families, seat prominence, layered physical table facts, projection sizing targets, RTL-stable poker geometry, and deep immutability. Human acceptance passed corrected scale and overall table coherence, but revealed cards and player identity still lack a non-overlapping ownership grammar. | `REPLAY-RAIL-NAV-001` / `QA-HANDSON-021` |
...
| QA-REVIEW-NAV-001 | PLANNED NEXT / AFTER CORE FLOW CORRECTNESS | Human evidence selects a vertical street-grouped navigator with first-class rail controls, Current Legal Actions, compact Hand Stage, direct Replay seeking, coherent card/seat/player/table ownership, folded-seat readability, physical Dealer treatment, contribution-line clarity, new timeline typography, 1080p efficiency, EN/RU/HE, RTL, and keyboard access. The current horizontal orientation is not permanent acceptance. | `REPLAY-RAIL-NAV-001` / `RET-REVIEW-NAV-001` |
| QA-TABLE-VNEXT-003 | PARTIAL / ACCEPTED FOUNDATION WITH UX DEBT | Existing experience events retain stack-to-contribution lanes, contribution-to-pot/pot-to-winner paths, seat-relative deals, table-interior folds, street/actor/hand-complete consequences, direct-seek suppression, and reduced-motion safety. The dotted contribution lanes are the implemented seat→street-contribution→pot connectors, but the second human pass found that they read as unexplained artifacts; the Hand redesign must clarify, simplify, or remove them based on comprehension. | `REPLAY-RAIL-NAV-001`; later audio acceptance under `RET-AUDIO-001` |
| QA-AUDIO-MOTION-001 | PARTIAL / ACCEPTED IMPLEMENTATION WITH LISTENING DEBT | The event/audio boundary, physical foley, and bounded poker-event sequencing remain implemented foundations. The final human disposition did not establish subjective listening acceptance; do not claim perfection. | completed `HANDS-ON-DEFECTS-001` implementation checkpoint; `GLOBAL-PRODUCT-QUALITY-001` / `RET-AUDIO-001` for later listening quality |
...
|---|---|---|---|
| HPR-2026-08 #4, #21, #28, #31–33, #38–40, #43–46, #48, #52 plus final Saved/table evidence | COMPLETED / ACCEPTED BOUNDED REPAIR CHECKPOINT WITH EXPLICIT DEBT | Human acceptance preserves Welcome title focus/Escape, clearer Home Game completion state, Return to live, auth feedback, dead-card/range parity, Analyze clipping, Personal Strategy vocabulary, and Replay geometry. Welcome nav selection, warning prominence, card/seat overlap, and broader #28/#33/#46 composition remain open with structural owners; no third bounded correction cycle. | accepted checkpoint `HANDS-ON-DEFECTS-001`; remaining owners below |
| HPR-2026-08 #4–5, #16–17 | DEFERRED / NAMED OWNER | Hand still appears selected on Welcome after two bounded attempts. Own recurring launch/home, sidebar and active-workspace semantics, first- versus returning-launch behavior, onboarding separation, and useful Guest Home density. | `FIRST-USE-HOME-001` |
| HPR-2026-08 #6–7, #14, #22–24 | DEFERRED / NAMED OWNER | Current interactive/visual Guide plus concise human content design. | `GUIDE-CONTENT-001` |
| HPR-2026-08 #1–3, #9, #15, #18, #27, #47, #58 | DEFERRED / ACCEPTED QUALITY DEBT | Intro/logo, spacing/sizing, semantic iconography, Account/Profile hierarchy, typography/casing, non-poker audio, and Royal Flush presentation. | `GLOBAL-PRODUCT-QUALITY-001` |
| HPR-2026-08 #8, #10–13 | DEFERRED / ACCEPTED CUSTOMIZATION DEBT | Compact control, richer card backs, clear custom-theme creation, Daylight comfort, and manual reduced-motion override. | `CUSTOMIZATION-UX-001` |
| HPR-2026-08 #19–20; #21 after accepted bounded clarity repair | DEFERRED / NAMED OWNER | Denser Riverline-integrated Home Game presentation, useful table/session representation, stronger proximate imbalance/toast feedback, and broader lifecycle presentation. | `HOME-GAME-PRESENTATION-001` |
| HPR-2026-08 #25–26, #35 | DEFERRED / NAMED OWNER | Reusable game setups/presets and physical Hero/button/Dealer/empty-seat configuration. | `GAME-SETUP-EVOLUTION-001` |
| HPR-2026-08 #29, #34; #28 and #33 after bounded repair; second-pass table debt | PLANNED NEXT / AFTER CORE FLOW CORRECTNESS | Vertical street-grouped chronology, first-class rail actions and Current Legal Actions, compact stage, coherent card/seat/player ownership, fold opacity, physical Dealer/gap treatment, contribution-line comprehension, table/history/action integration, and timeline typography. | `REPLAY-RAIL-NAV-001` |
...
| HPR-2026-08 #36–37, #41–42, #53; #38–40 after bounded repair | DEFERRED / NAMED OWNER | Matrix locality, truthful comparison/card-removal presentation, local legend, decision-fact discovery, and progressive depth. | `ANALYZE-RANGE-UX-001` |
| HPR-2026-08 #46 after bounded repair | PLANNED NEXT | One primary start CTA, stable pre/post skeleton, top packing, Action History, Assistance, Memory, setup/status, and progressive explanation depth. | `TRAINING-COMPOSITION-001` |
| HPR-2026-08 #49–51, #54 | PLANNED NEXT / AFTER REPLAY AND TRAINING COMPOSITION | Game setup/Approach first value, broad sparse/high-information coverage before boundary refinement, and Teach Riverline Next/Matrix Edit consolidation. | `PERSONAL-STRATEGY-003A` |
...
| HPR-2026-08 #56–57 | DEFERRED / NAMED OWNER | Bounded player composition, optional naming, central calculation controls, and dominant Equity result. | `EQUITY-COMPOSITION-001` |
| HPR-2026-08 #59 | DEFERRED / NAMED OWNER | Observer-safe payload-owned Saved Spot visual previews. | `SAVED-VISUAL-KNOWLEDGE-001` |

## Second acceptance findings — active Core Flow correctness

| ID | Status | Issue | Owner |
|---|---|---|---|
| QA-CORE-FLOW-NEW-HAND-001 | ACTIVE | A completed canonical Hand remains reviewable/savable but exposes no obvious Start new Hand lifecycle. The action must create a fresh canonical Hand from the current or intentionally chosen setup without mutating completed history and without relying on reload/reset. | `CORE-FLOW-CORRECTNESS-001` |
| QA-HOME-GAME-CORRECTION-001 | ACTIVE | After an accidental cash-out, the existing append-only correction/reversal model is not conveniently reachable. Expose the canonical reversal/correction path for cash-out and other eligible transactions; never edit ledger history destructively. | `CORE-FLOW-CORRECTNESS-001` |
| QA-KNOWN-CARD-PICKER-001 | ACTIVE | Selecting the first known opponent card collapses the picker before the intended two-card entry is complete. Keep it open through two legal selections or explicit dismissal while preserving duplicate-card legality and hidden-card privacy. | `CORE-FLOW-CORRECTNESS-001` |
| QA-MIN-RAISE-VERIFY-001 | ACTIVE / VERIFY BEFORE CHANGE | The reported 7bb→13bb reraise is not evidence of a defect by itself: after a raise-to 7bb over a 1bb big blind, the last full increment is 6bb and 13bb may be the exact minimum. Reconstruct canonical history and test opening bet, ordinary raise, reraise, short all-in, and action reopening; change runtime only if canonical no-limit legality is wrong. | `CORE-FLOW-CORRECTNESS-001` |
...
| QA-HANDSON-014 | PARTIAL / STRUCTURAL COMPOSITION DEBT | Training has intentional pre-session availability states, stable Progress labels, canonical abandoned-session confirmation, and collapsed long analysis. The defect checkpoint does not accept Training composition; duplicate start actions, top packing, stable pre/post geometry, Action History, Assistance, Memory, and explanation depth remain with the dedicated owner. | `TRAINING-COMPOSITION-001`; `RET-COMPOSITION-002` |
| QA-HANDSON-015 | PARTIAL / STRUCTURAL HAND DEBT | The accepted table scale and HU/full-ring geometry remain foundations. Making revealed cards fully visible introduced awkward overlap with player identity/stack presentation; repeated local layer patches stop here. Cards must visibly belong to the player while both objects remain readable across HU through full ring and Dealer placement remains coherent. | `REPLAY-RAIL-NAV-001` / `RET-REVIEW-NAV-001` |
...
| QA-HANDSON-017 | PARTIAL / ACCEPTED FOUNDATION WITH CONFIRMED DEBT | Compact Equity player tiles and input/running/completed continuity remain useful; do not restore old horizontal result blocks. HPR-2026-08 #56–57 confirms that the region still displaces Board/Dead/Method, lacks useful consistent naming, and under-prioritizes the principal result. | `EQUITY-COMPOSITION-001`; `RET-EQUITY-001` |
...
| QA-HANDSON-021 | PARTIAL / STRUCTURAL DEBT CONFIRMED | Known-card rendering preserves rank+suit identity and hidden-card privacy, but the latest layer correction can make revealed cards overlap player identity/stack awkwardly. Future Hand work must keep cards and player visuals mutually readable, visibly owned, and coherent across HU through full ring without another isolated z-index/offset patch. | `REPLAY-RAIL-NAV-001` / `RET-REVIEW-NAV-001` |
...
| QA-UI-005 | PARTIAL / ACCEPTED FOUNDATION WITH STRUCTURAL DEBT | `table-presentation/v1` integrates hole cards with each adaptive 2–10 player unit while preserving name, position, stack, action, and prominence facts. Overall table integration remains a foundation, but revealed cards and player identity can overlap and require one coherent Hand composition owner. | `REPLAY-RAIL-NAV-001` / `QA-HANDSON-021` |
...
| QA-PERSONAL-002R | PARTIAL | The [independent product/architecture review and human disposition](PERSONAL_STRATEGY_002R_REVIEW.md) are complete and accepted. HPR-2026-08 #49–55 adds confirmed hands-on evidence for the accepted Game setup/Approach reset, broad coverage before boundary refinement, raw-label repair, surface consolidation, and a later genuine teaching owner. `003A` follows final defect acceptance, Replay rail, and Training composition. Existing and future-migrated EN/HE/RU visual/real-user acceptance remains unperformed. | `HANDS-ON-DEFECTS-001`; `PERSONAL-STRATEGY-003A`; `PERSONAL-STRATEGY-TEACHING-001` |
...
| QA-MATRIX-001 | PARTIAL / ACCEPTED CORRECTNESS WITH DESIGN DEBT | Human acceptance confirms card-removal parity and raw Personal Strategy identifiers remain fixed. Distant selected-hand detail, unclear comparison, and a missing local/persistent legend remain open design work. | `ANALYZE-RANGE-UX-001` |
...
| QA-EQUITY-001 | OPEN / CONFIRMED | Equity workspace remains loosely assembled; HPR-2026-08 #56–57 confirms player-tile over-allocation, displaced core controls, and under-prioritized results. | `EQUITY-COMPOSITION-001` |
| QA-EQUITY-002 | OPEN / CONFIRMED | Equity labels/names/results need a consistent readable composition without expanding every player tile. | `EQUITY-COMPOSITION-001` |
...
| QA-TABLE-001 | PARTIAL / ACCEPTED FOUNDATION WITH STRUCTURAL DEBT | The active Hand renders canonical facts through `table-presentation/v1`; default Balanced occupancy, HU composition, layered-table coherence, and Hero readability remain accepted foundations. Revealed card/player overlap, folded-seat legibility, Dealer physicality, unexplained contribution lines, and the table/action/timeline relationship remain structural Hand debt. | `REPLAY-RAIL-NAV-001` / `QA-HANDSON-021` |
