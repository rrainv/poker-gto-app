...
Last consolidated: August 27, 2026 (`CORE-FLOW-CORRECTNESS-001` completed human-QA correction #1 and requires final human acceptance; `REPLAY-RAIL-NAV-001` remains planned next but blocked on that acceptance; no broad HPR or composition closure is implied).
...
| HPR-2026-08 #29, #34; #28 and #33 after bounded repair; second-pass table debt | PLANNED NEXT / BLOCKED ON CORE FLOW HUMAN ACCEPTANCE | Vertical street-grouped chronology, first-class rail actions and Current Legal Actions, compact stage, coherent card/seat/player ownership, fold opacity, physical Dealer/gap treatment, contribution-line comprehension, table/history/action integration, and timeline typography. | `REPLAY-RAIL-NAV-001` |
...
## Second acceptance findings — Core Flow implementation complete, human acceptance pending

| ID | Status | Issue | Owner |
|---|---|---|---|
| QA-CORE-FLOW-NEW-HAND-001 | IMPLEMENTATION COMPLETE / FINAL HUMAN ACCEPTANCE REQUIRED | The completed state keeps Review/Replay/Analysis/Save and explicit `Start new hand`; human correction makes Review and Start new hand the two primary actions without changing lifecycle. Fresh setup/focus/transient clearing/new identity and frozen completion remain verified. Focused Node and Firefox 154 EN/RU/HE/RTL checks pass. | final `CORE-FLOW-CORRECTNESS-001` human acceptance |
| QA-HOME-GAME-CORRECTION-001 | IMPLEMENTATION COMPLETE / FINAL HUMAN ACCEPTANCE REQUIRED | Active sessions expose `Correct entries` across uncorrected buy-in, rebuy, add-on, and cash-out entries, retain the direct cash-out shortcut, and accept an optional reason as `null` when absent without invented ledger prose. Existing immutable reversal/replacement, operable confirmation, and completed-session reopen semantics remain unchanged. Focused application and Firefox 154 EN/RU/HE/RTL checks pass. | final `CORE-FLOW-CORRECTNESS-001` human acceptance |
| QA-KNOWN-CARD-PICKER-001 | IMPLEMENTATION COMPLETE / FINAL HUMAN ACCEPTANCE REQUIRED | Hand private-card selection advances through the second slot; first Escape closes only the nested picker while preserving the expanded known-opponent disclosure, first card, and logical second-slot focus. Cross-seat duplicate exclusion, multiple opponents, and HU through 10-handed remain automated; targeted Firefox keyboard/pointer checks pass. | final `CORE-FLOW-CORRECTNESS-001` human acceptance |
