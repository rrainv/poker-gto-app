...
Last refreshed: August 31, 2026 (`DECISION-CONTEXT-SINGLE-AUTHORITY-001` is accepted; `AUDIT-HIGH-RISK-REPRO-001` now leads the remaining foundational gates).
...
21. **ACTIVE NEXT / HIGH-RISK REPRODUCTION — `AUDIT-HIGH-RISK-REPRO-001`** — reproduce the eleven preserved blind findings before any fix or acceptance claim.
