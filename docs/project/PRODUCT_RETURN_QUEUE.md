...
Last refreshed: August 25, 2026 (`WORKSPACE-COMPOSITION-002` accepted as an implementation checkpoint with compact return debt; `DOCS-CAPABILITY-DOSSIERS-001` is active next).
