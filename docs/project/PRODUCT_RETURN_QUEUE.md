...
| RET-HOMEGAME-001 | RETURN-SOON | Home Game Organizer | Create Game now stays in Home Game Organizer and opens the intended active session. `HOME-GAME-001A` remains incomplete for saved-player edit/archive, visible correction history, archive/delete confirmation, richer management UX, import/export decision, and broader Firefox acceptance. | `HOME-GAME-001B` |
