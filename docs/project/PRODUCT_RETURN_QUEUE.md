...
Last refreshed: August 24, 2026 (`UX-REGRESSION-001` accepted; remaining hands-on debt reconciled).
...
| RET-TABLE-001 | RETURN-SOON | Hand / Table Presence | `TABLE-PRESENCE-002` implemented adaptive geometry and table hierarchy; `UX-REGRESSION-001` repaired immediate Table Focus scale and known-card identity with bounded HU/6-max/10-max Firefox acceptance. Broader table balance/default physicality and independent Full Hand states remain open. | `WORKSPACE-COMPOSITION-002` → `TABLE-PHYSICALITY-003` → closeout |
...
| RET-CARDS-THEMES-001 | RETURN-SOON | Cards / Themes / Layout / Density | `UX-REGRESSION-001` accepted picker/known-card legibility, transactional theme editing, and immediate Table Focus scaling. Weak preset/density value, broader composition, Settings IA, and remaining independent visual closeout stay open; do not add variants before fixing defaults. | `WORKSPACE-COMPOSITION-002`, `SETTINGS-IA-001`, then closeout |
