...
Last refreshed: August 24, 2026 (`AUDIO-MOTION-001` accepted checkpoint; subjective audio polish debt retained).
...
|---|---|---|---|---|
| RET-TABLE-001 | RETURN-SOON | Hand / Table Presence | `TABLE-PRESENCE-002` implemented adaptive geometry and table hierarchy; `AUDIO-MOTION-001` now adds bounded TablePresentation-based card/fold/chip/pot/street consequences without changing poker authority. Independent human Firefox interaction and remaining visual acceptance are still open; implementation is not visual sign-off. | human Firefox acceptance + `PREMIUM-CLOSEOUT-001` |
