...
export const CALIBRATION_SETUP_TUTORIAL_DEFINITION = definition({
  ...
  steps: [
    ...
    { id: 'teacher', anchor: 'range-teacher-tab', titleKey: 'Learn from your own strategy', bodyKey: 'Range Teacher explains boundaries, conflicts, and unknown regions in your own Personal Strategy evidence. Its suggestions are optional and never grade you against GTO or a reference strategy.', placement: 'bottom', precondition: 'calibration-configured' },
