...
export const PLAYBOOK_ANALYSIS_TUTORIAL_DEFINITION = definition({
  ...
  descriptionKey: 'Read exact-hand, draw, blocker, range, strategy, and source facts without overstating what Riverline knows.',
  steps: [
    ...
    { id: 'blockers', anchor: 'playbook-analysis-explanation', titleKey: 'Read blocker effects structurally', bodyKey: 'Hero-card blockers report exact card removal. If an opponent range is explicitly supplied, Analysis also reports the known combo mass removed; it does not call a blocker good or bad for bluffing.', placement: 'bottom' },
