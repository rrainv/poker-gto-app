...
export const HAND_TUTORIAL_DEFINITION = definition({
  ...
  steps: [
    ...
    { id: 'setup', anchor: 'hand-setup', titleKey: 'Start the canonical hand', bodyKey: 'Save your usual rules and stack as a Table preset. Loading updates the draft only. Choose Hero by poker position and move the Dealer with the selector or a preview seat. Start hand commits the setup.', placement: 'right' },
...
export const EQUITY_ADVANCED_TUTORIAL_DEFINITION = definition({
  ...
  steps: [
    ...
    { id: 'runouts', anchor: 'equity-runouts', titleKey: 'Inspect ranges and hypothetical cards', bodyKey: 'Ranges & runouts has its own workspace below the matchup. Set exact hands or explicit weights, then calculate. Unknown combinations stay unknown; partial Equity requires permission. Expand Runout Explorer and focus a card to inspect its best five. Cards are hypothetical; hand improvement and Equity improvement remain separate.', placement: 'top' },
  ],
});
...
export const CALIBRATION_SETUP_TUTORIAL_DEFINITION = definition({
  ...
  steps: [
    ...
    { id: 'understanding', anchor: 'personal-understanding', titleKey: 'Read coverage, not a completion score', bodyKey: 'The map stays beside your question. Select a known hand to inspect or correct it, or an unknown hand to teach it. Use arrow keys to explore. Coverage counts evidence, not strategy completion.', placement: 'bottom', precondition: 'calibration-configured' },
...
export const CALIBRATION_ANSWERS_TUTORIAL_DEFINITION = definition({
  ...
  steps: [
    ...
    { id: 'quick', anchor: 'calibration-answer-actions', titleKey: 'Quick answers mean dominant action', bodyKey: 'Answer with your preferred action or an optional exact mix. A preferred action never means the action is played at a pure 100% frequency. Read what Riverline learned, then Continue. What I\'ve taught keeps saved answers available for inspection and correction with history preserved, even when Teacher asks about other hands.', placement: 'bottom', precondition: 'calibration-question-ready' },
