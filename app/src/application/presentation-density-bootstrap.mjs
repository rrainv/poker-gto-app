...
function initializePresentationPreferences() {
  const themeController = createPresentationThemeController({
    ...
    editButton: document.querySelector('#editTheme'),
    saveChangesButton: document.querySelector('#saveThemeChanges'),
    cancelEditButton: document.querySelector('#cancelThemeEdit'),
